...
def build_parse() -> ArgumentParser:
    ...
    parser.add_argument("--mount_path", required=False, type=str, default="/home")
    return parser
...
def main(args: Namespace):
    ...
    project_name = pyproject_file_content["project"]["name"]
    ...
    placeholders["website_name"] = version_file_content["frontend"]["name"]
    placeholders["website_version"] = version_file_content["frontend"]["version"]
